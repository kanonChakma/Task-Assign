...
const TodoList:React.FC<props> = ({progressTodo,setProgressTodo,toDoData,setToDoData,completedTodo,setCompletedTodo}) => {
  return (
      <div className='container'>
       ...
       {
         (provided, snapshot)=>(
          <div className={`todos progress ${snapshot.isDraggingOver?'dragProcess':""}`}
          {...provided.droppableProps} ref={provided.innerRef}>
